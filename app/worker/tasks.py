...
def run_pipeline_task(
    ...
    port_annotations: List[Dict[str, Any]] | None = None,
    net_role_assignments: List[Dict[str, Any]] | None = None,
    net_alias_assignments: List[Dict[str, Any]] | None = None,
    net_merge_assignments: List[Dict[str, Any]] | None = None,
    ...
    try:
        raw = run_pipeline(
            ...
            net_role_assignments=net_role_assignments,
