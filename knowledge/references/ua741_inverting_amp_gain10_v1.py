...
circuit = Circuit(
    ...
    name="uA741 反相放大器（增益 10）逻辑参考电路",
    description="由 uA741、输入电阻 R1、反馈电阻 Rf 和同相端接地偏置电阻 Rp 构成的反相放大器逻辑参考电路。",
    ...
    design_goal="inverting_gain_10",
    gain_ratio="Rf/R1 = 10",
    input_signal="30 mVpp, 1 kHz, no DC offset",
)
...
UO1 = circuit.output("UO1", label="UO1", description="反相放大输出")
...
Rf = Resistor("Rf", value="10 * R1", description="反馈电阻：连接输出与反相输入，Rf/R1=10")
